...
#include "exclamation/cuda/algorithms.cuh"
#include "exclamation/cuda/cuda_common.cuh"
#include "exclamation/cuda/paged_attention/attention_common.cuh"
#include "exclamation/cuda/paged_attention/lbp_attention_task.cuh"
#include "exclamation/cuda/type_convert.cuh"
#include "exclamation/cuda/warp_utilities.cuh"
...
struct PagedGroupQueryAttentionTask : public PagedAttentionTask<NumThreads, HeadSize, PageSize, TI, TO_, TKV, Worker, Config, KVConfig> {
  ...
  using TaskChunk = exclamation::TaskChunk<Config::TaskChunkSeqLen, PageSize>;
  using FlashAccCta = exclamation::FlashAccCta<NumThreads, HeadSize>;
  using FlashAccWarp = exclamation::FlashAccWarp<NumThreads, HeadSize>;
