...
#if !defined(EXCLAMATION_SPLIT_COMPILATION) || defined(RESHAPE_AND_CACHE_KERNEL_IMPL)
{
  using input_t = half;
  ...
  constexpr int HeadSizeNextPowerOfTwo = exclamation::next_power_of_two(HeadSize);
